...
<c:set var="municipio" value="${ user.municipio }" />
</c:forEach>
<html lang="en">
<head>
...
<main name="">
    ...
    <div class="alinear margen3">
        <a type="button" class="btn boton" data-bs-toggle="modal" data-bs-target="#register" action="${context}/ServletAdmin"> Agregar Enlace</a>
        <form class="d-flex" action="${context}/searchUser" method="post">
            <input name="idRol" type="hidden" value="2">
    ...
    <div class="alinear3 texto2">
        <table class="table table2">
            ...
            <tbody>
            <c:forEach items="${ listEnlaces }" var="enlace" varStatus="status">
                <tr>
                    <td>${enlace.idEmpleados }</td>
                    <td>${ enlace.nombreEmpleados } ${ enlace.aPaterno } </td>
                    <td>
                        <form action="${context}/deleteUser" method="POST">
                            <input type="hidden" name="action" value="delete">
                            <input type="hidden" name="rolUsuario" value="${ enlace.idRoles }">
                            <input type="hidden" name="idUser" value="${ enlace.idEmpleados }">
